...
IF V_COUNT > 0  and p_amount >=0 THEN
...
dbms_output.put_line('Error Depositing');
END IF;
...
INSERT INTO TRANSACTION_LOG(LOG_ID, ACCOUNT_NUMBER, TRANSACTION_TYPE, AMOUNT, TRANSACTION_TIME)VALUES
...
--MODIFY TRANSACTION_TIME TIMESTAMP;
